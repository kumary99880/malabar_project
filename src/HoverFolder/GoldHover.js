...
import '../HoverFolder/GoldHover.css'; // Ensure this file exists for styling
...
const GoldHover = () => {
  ...
  return (
    ...
    >
      <a href="#!" className="hover-link" style={{color:'#9A0056',fontSize:'15px'}}>GOLD</a>
      {isHovered && (
        <div className="Gold" style={{ display: 'flex' }}>
          <div className='Ring'>
