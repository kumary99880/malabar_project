...
import '../HoverFolder/Platinum.css';  // Ensure this file exists for styling
...
const Platinum = () => {
  ...
  return (
    ...
    >
      <a href="#!" className="hover-link"  style={{color:'#9A0056',fontSize:'15px'}}>PLATINUM</a>
      {isHovered && (
        <div className="Platinum" style={{ display: 'flex' }}>
          <div className='Ring'>
